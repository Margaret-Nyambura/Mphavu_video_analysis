...
#         if success:
#             output_path = os.path.join(output_folder, f"tracked_{frame_count:04d}.jpg")
...
#     video_path = '/home/studen/Downloads/Screencast from 16-08-2024 12_00_15 WB.webm' # Adjust the path if necessary
